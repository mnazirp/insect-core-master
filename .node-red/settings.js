...
module.exports = {
  ...
  flowFile: process.env.NODE_RED_FLOWFILE
    ? process.env.NODE_RED_FLOWFILE
    : "flows.json",
    ...
    users: [
      {
        username: "admin",
        password:
          "$2a$08$Eme.Tq7F8FfqLWE6JzFqMOZGOsnDAvbau6ju7HDZtpz/Jfgzk3znK",
        permissions: "*",
      },
    ],
  },
  ...
  //  pass: process.env.DASHBAORD_PASSWORD,
  // },
